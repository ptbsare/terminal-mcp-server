...
async function parseSshConfigAliases() {
        ...
        try {
            ...
            try {
                ...
                if (error instanceof Error && error.message.includes('SSH')) {
                    throw new McpError(ErrorCode.InternalError, `SSH connection error: ${error.message}. Please ensure SSH key-based authentication is set up.`);
                }
                throw error;
            }
        }
